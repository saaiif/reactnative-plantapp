...
import { Animated, Dimensions, StyleSheet, FlatList, Modal, ScrollView, Image } from 'react-native';
            ...
            >
                <Block padding={[theme.sizes.padding * 2, theme.sizes.padding]} space="between">
                    ...
                    <ScrollView style={{ marginVertical: theme.sizes.padding }}>
                        ...
                        <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
                            3. You understand that Expo uses third-party vendors and hosting partners to provide the
                        ...
                        <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
                            ...
                            imply that it is associated with the Service, Expo, or any other Expo service.
                        </Text>
                        <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
                            5. You may use the Expo Pages static hosting service solely as permitted and intended to
                            host your organization pages, personal pages, or project pages, and for no other purpose.
                            You may not use Expo Pages in violation of Expo's trademark or other rights or in violation
                            of applicable law. Expo reserves the right at all times to reclaim any Expo subdomain
                        ...
                        <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
                            7. We may, but have no obligation to, remove Content and Accounts containing Content that we
                        ...
                        <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
                            8. Verbal, physical, written or other abuse (including threats of abuse or retribution) of
                            any Expo customer, employee, member, or officer will result in immediate account
                            termination.
                        </Text>
                        <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
                            9. You understand that the technical processing and transmission of the Service, including
                    ...
                    <Block middle padding={[theme.sizes.base / 2]}>
            ...
            <Screen>
                <Block style={{ backgroundColor: 'white' }}>
                    ...
                    <Block middle flex={0.5} margin={[0, theme.sizes.padding]}>
                        ...
                        <Button shadow onPress={() => this.setState({ showTerms: true })}>
                            <Text center semibold gray>
                                Terms of services
                            </Text>
                        </Button>
                    </Block>
